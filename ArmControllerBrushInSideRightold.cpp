...
int main()
{
    ...
    std::ofstream forcerepairedoutputfile("D:\\UsmileProject\\hand_eye_calibration\\transformsrepairedforceinsideright.txt");
    ...
    // //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@加载修复好固定力控的数据@@@@@@@@@@@@@@@@@@@@@@@2
    // std::ifstream forceinfilerepair("D:\\UsmileProject\\hand_eye_calibration\\transformsrepairedforceinsideright.txt");
