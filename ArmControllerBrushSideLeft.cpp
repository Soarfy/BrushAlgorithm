...
int main()
{
    ...
    {
        int poseWaitMs = 0;
        while (poseWaitMs < 15000 &&
               !demo->getCurrentPose(0, 5, gxdown2, gydown2, gzdown2, grxdown2, grydown2, grzdown2))
        {
            std::cout << "获取姿态中。。。。。" << std::endl;
    ...
    {
        // ================= 模式1 / 模式3 精简自动流程 =================
        const std::string Std_Traj_Json = "../defaultconfig/leftside/standard_trajectory.json";
        const std::string Std_Traj_Json_NoComp = "../defaultconfig/leftside/standard_trajectory_nocomp.json";
