...
{
    // @@@@@@@@@@@@@@@@@@@@@@@@區別代碼@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    const std::string Force_FILE_PATH = "../defaultconfig/sideahead/sideright.txt";
    ...
    std::string indexFilePath3 = "../defaultconfig/sideahead/ee_poses.txt";
