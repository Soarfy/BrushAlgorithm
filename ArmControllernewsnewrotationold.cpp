...
int main()
{
    ...
    // c2::Acc acc{80, 80, 80};
    // c2::Speed speed{80, 80, 80};
    // c2::Acc acc{30, 30, 30};


    c2::Speed speed{30, 30, 30};
    c2::Acc acc{10, 10, 10};
    struct PointData
    {
        double x, y, z, a, b, c;
    ...
    // //重新开始
    // // c2::Speed brushspeedrestart{60, 60, 60};
    // // c2::Acc brushaccrestart{30, 30, 30};
    // // c2::MovJointSegments brushingtrajectorysrestart;
    // // c2::Point cposrestart;
    // // cposrestart.type = c2::PointType::Cart;
    // // cposrestart.cpos.x = 25.411;
    // // cposrestart.cpos.y = 452.19;
    // // cposrestart.cpos.z = 422.686;
    // // cposrestart.cpos.a = -179.534;
    // // cposrestart.cpos.b = -0.215;
    // // cposrestart.cpos.c = 90.558;
    // // brushingtrajectorysrestart.AddMovJ(cposrestart, brushspeedrestart, brushaccrestart, c2::ZoneType::Fine, zone);
    // // arm.StartBrushTeethTrajectoryJoint(brushingtrajectorysrestart);
    // // char answers = 'n';
    // // std::cout << "Please add toothbrush to the griper and press y" << std::endl;
    // // std::cin >> answers;
    // //重新开始结束的时候
    ...
    c2::Speed brushspeed{30, 30, 30};
    c2::Acc brushacc{10, 10, 10};

    // // c2::Speed brushspeed{80, 80, 80};
    // // c2::Acc brushacc{40, 40, 40};
    // // c2::CPos pose;
    ...
    // std::vector<PointData> brushpointsoffsetdiff;
    ...
    //         // cpos.cpos.a = brushpoints[0].a + offset.a;
    //         // cpos.cpos.b = brushpoints[0].b + offset.b;
    //         // cpos.cpos.c = brushpoints[0].c + offset.c;
    ...
    // std::cout << "Running Python script to generate brush offsets..." << std::endl;
    // int python_resultright = std::system("cmd /c \"D:\\line\\pythonProject\\.venv\\Scripts\\activate && python D:\\hand_eye_calibration\\GeneratePathOffset66.py\"");
    ...
    // c2::Speed brushspeedright{6, 6, 6};
    // c2::Acc brushaccright{3, 3, 3};
    // // c2::CPos pose;
    ...
    // std::ifstream infileright("D:\\hand_eye_calibration\\saved_ply\\transforms2.txt");
    ...
    // double dxright, dyright, dzright, rxright, ryright, rzright;
    // while (infileright >> dxright >> dyright >> dzright >> rxright >> ryright >> rzright)
    // {
    //     std::cout << "Read values: " << dxright << " >> " << dyright << " >> " << dzright << " >> " << rxright << " >> " << ryright << " >> " << rzright << std::endl;
    //     brushpointsoffsetright.push_back({dxright, dyright, dzright, rxright, ryright, rzright});
    // }
    ...
    // std::cout << "Running Python script to generate brush offsets..." << std::endl;
    // int python_resultrights = std::system("cmd /c \"D:\\line\\pythonProject\\.venv\\Scripts\\activate && python D:\\hand_eye_calibration\\GeneratePathOffset66.py\"");
    ...
    // c2::Speed brushspeedrights{6, 6, 6};
    // c2::Acc brushaccrights{3, 3, 3};
    // // c2::CPos pose;
    ...
    // std::ifstream infilerights("D:\\hand_eye_calibration\\saved_ply\\transforms.txt");
    // if (!infilerights.is_open())
    // {
    //     std::cerr << "Failed to open brush_offset.txt (rights)" << std::endl;
    //     return -1;
    // }
    // else
    // {
    ...
    // double dxrights, dyrights, dzrights, rxrights, ryrights, rzrights;
    // while (infilerights >> dxrights >> dyrights >> dzrights >> rxrights >> ryrights >> rzrights)
    // {
    //     std::cout << "Read values: " << dxrights << " >> " << dyrights << " >> " << dzrights
    //               << " >> " << rxrights << " >> " << ryrights << " >> " << rzrights << std::endl;
    //     brushpointsoffsetrights.push_back({dxrights, dyrights, dzrights, rxrights, ryrights, rzrights});
    // }
