...
int main()
{
    std::cout << "Start BrushUpLeft" << std::endl;
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@机械臂初始化@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ArmController arm;
    ...
    if (python_result1 != 0)
    {
        std::cerr << "Python script GeneratePathOffset66BrushOther6.py execution failed!" << std::endl;
        return -1;
    }
    ...
    std::ofstream forcerepairedoutputfile("D:\\UsmileProject\\hand_eye_calibration\\transformsrepairedforceupleft.txt");
    ...
    // //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@加载修复好固定力控的数据@@@@@@@@@@@@@@@@@@@@@@@2
    // std::ifstream forceinfilerepair("D:\\UsmileProject\\hand_eye_calibration\\transformsrepairedforceupleft.txt");
