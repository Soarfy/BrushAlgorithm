...
int main()
{
    std::cout << "Start BrushInSideLeft" << std::endl;
    // @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@机械臂初始化@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ArmController arm;
    ...
    // @@@@@@@@@@@@@@@@@@@@@@@@@旋转拍摄替换图片和点云@@@@@@@@@@@@@@@@@@@@@@@@2
    int rotate = std::system("cmd /c \"D:\\UsmileProject\\hand_eye_calibration\\.venv312\\Scripts\\activate && python D:\\UsmileProject\\hand_eye_calibration\\TcpclientRight.py\"");
    if (rotate != 0)
    {
    ...
    std::ofstream forcerepairedoutputfile("D:\\UsmileProject\\hand_eye_calibration\\transformsrepairedforceinsideleft.txt");
    ...
    // //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@加载修复好固定力控的数据@@@@@@@@@@@@@@@@@@@@@@@2
    // std::ifstream forceinfilerepair("D:\\UsmileProject\\hand_eye_calibration\\transformsrepairedforceinsideleft.txt");
