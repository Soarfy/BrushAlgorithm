...
{
    // @@@@@@@@@@@@@@@@@@@@@@@@區別代碼@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    const std::string Force_FILE_PATH = "../defaultconfig/leftup/upleft.txt";
    // const std::string Brush_offset = "../defaultconfig/leftup/brushoffsets.json";

    const std::string Movs_FORCE_LOG_PATHs = "../defaultconfig/leftup/movs_force_during_movs.txt";
    ...
    const std::string Brush_offset_path = "../defaultconfig/leftup/brushoffsets_path.json";
    ...
    const std::string oldsegment ="../defaultconfig/leftup/all_segments.txt";
    std::string indexFilePath = "../defaultconfig/leftup/all_segments.txt";
    std::string indexFilePath2 = "../defaultconfig/leftup/support_points.txt";
    std::ofstream poseFile("../defaultconfig/leftup/current_pose_from_getpose.txt");
    const std::string eepath ="../defaultconfig/leftup/ee_poses.txt";
   ...
   Dobot::CDescartesPoint rotatetooljointjump{};
    ...
    // double modifiedupz = 48.16690799999924 +7.156301999999357;
    ...
    else
    {
        ...
        if (inputFile.is_open())
        {
            ...
            Dobot::CDescartesPoint pointa{};
            pointa.x = 264.89290+modifiedupx + offsetX;
    ...
    {
        // ================= 模式1 / 模式3 精简自动流程 =================
        const std::string Std_Traj_Json = "../defaultconfig/leftup/standard_trajectory.json";
        const std::string Std_Traj_Json_NoComp = "../defaultconfig/leftup/standard_trajectory_nocomp.json";
